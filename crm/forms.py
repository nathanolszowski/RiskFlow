...
class CompanyForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        input_classes = (
            ...
            "text-gray-100 placeholder-gray-400 focus:border-indigo-500 focus:ring-indigo-500"
        )
        for name, field in self.fields.items():
            field.widget.attrs.update({"class": input_classes})
        # Placeholders
        self.fields["name"].widget.attrs["placeholder"] = "Ex: RiskFlow SAS"
        self.fields["siren"].widget.attrs.update({"placeholder": "123456789", "maxlength": "9"})
        self.fields["siret"].widget.attrs.update({"placeholder": "12345678900012", "maxlength": "14"})
        self.fields["vat_number"].widget.attrs["placeholder"] = "FR12345678901"
        self.fields["business_line"].widget.attrs["placeholder"] = "Ex: Industrie, Conseil..."
        self.fields["legal_structure"].widget.attrs["placeholder"] = "Ex: SAS, SARL, SA..."
        self.fields["company_size_category"].widget.attrs["placeholder"] = "Ex: PME, ETI, Grande entreprise..."
        self.fields["nb_employees"].widget.attrs["placeholder"] = "45"
        self.fields["website"].widget.attrs["placeholder"] = "https://www.entreprise.com"
        self.fields["address"].widget.attrs["placeholder"] = "Adresse complète du siège..."
        self.fields["labels"].widget.attrs["placeholder"] = "ISO 9001, MASE, etc."
        self.fields["executive_board"].widget.attrs["placeholder"] = "Membres du conseil / dirigeants..."
